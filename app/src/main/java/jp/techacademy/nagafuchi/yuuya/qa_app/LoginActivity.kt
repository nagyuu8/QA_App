...
class LoginActivity : AppCompatActivity() {
    ...
    //アカウント作成時にフラグを建て、ログイン処理後に名前をFirebaseに保存する。
    private var mIsCreateAccount = false

    override fun onCreate(savedInstanceState: Bundle?) {//TODO Firebase関連の初期化.UIの準備。
     ...
     * @param email ログインe-mailを与える
     * @param password ログインパスワードを与える。
     */
